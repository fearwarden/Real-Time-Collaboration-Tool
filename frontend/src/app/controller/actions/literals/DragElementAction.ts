...
export default class DragElementAction extends AbstractMouseAction {
  ...
  onMouseMove(e: MouseEvent): void {
    ...
    canvas.activeElement.elementNode.handleMouseMove(
      worldCoorindates.x,
      worldCoorindates.y,
    );
  }
  ...
  onMouseDown(e: MouseEvent): void {
    ...
    canvas.activeElement.elementNode.handleMousePressed(
      worldCoorindates.x,
      worldCoorindates.y,
    );
  ...
  onMouseUp(e: MouseEvent): void {
    const canvas = Main.getInstance().canvas!;
    if (!(canvas.activeElement?.elementNode instanceof MovableElementNode))
      return;
