		...
		<>
			<div className="menu-wrapper h-full bg-cyan-900">
				...
				<div className="flex">
					<img
						className="cursor-pointer"
						onClick={Main.getInstance().actionManager.startPenStateAction.doAction}
						src={Pencil}></img>
					<img
						className="cursor-pointer"
						onClick={Main.getInstance().actionManager.startEraserStateAction.doAction}
						src={Eraser}></img>
					<img
						className="cursor-pointer"
						onClick={() => {
					...
					<div>
						...
						<input
							...
							step="1"
							value={penThinckness}
							onChange={handleThicknessChange}></input>
